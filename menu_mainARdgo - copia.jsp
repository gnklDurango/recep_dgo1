...
<table width="1326" height="449" border="6" cellpadding="2" bgcolor="#FFFFFF">
  <tr>
    <td width="1304" height="445"><table width="100%" height="435" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr bgcolor="#3366CC">
        <td height="64" colspan="3" align="center" valign="top" bgcolor="#FFFFFF" id="tagline"><div align="justify"><strong><span class="style1">Bienvenido(a) <%=session.getAttribute("username")%></span></strong></div></td>
        <td width="4" bgcolor="#FFFFFF">&nbsp;</td>
      </tr>
      <tr>
      ...
      <tr>
        <td width="225" valign="top" bgcolor="#E6F3FF"><table border="0" cellspacing="0" cellpadding="0" width="165" id="navigation">
          ...
           
          <div align="center" class="style3"><strong><span class="style2">Av. Emiliano Zapata lote 2 <br />
        ...
        <td colspan="2" valign="top"><img src="mm_spacer.gif" alt="" width="305" height="1" border="0" /><br />
          ...
          <table border="0" cellspacing="0" cellpadding="0" width="305">
            <tr>
              <td class="pageName">Men&uacute; de Opciones </td>
            </tr>
            <tr>
              <td class="bodyText"><br />
              <p><a href="captura_provdgo.jsp">Capturar Medicamento </a></p>
