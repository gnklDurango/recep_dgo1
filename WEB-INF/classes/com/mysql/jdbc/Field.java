 ...
 * @version $Id: Field.java,v 1.15.2.13 2004/09/04 00:14:12 mmatthew Exp $
 */
public class Field {
    ...
    */
    ...
    Field(Connection conn, byte[] buffer, int nameStart, int nameLength,
        int tableNameStart, int tableNameLength, long length, int mysqlType,
    ...
    Field(Connection conn, byte[] buffer, int databaseNameStart,
        ...
        int originalColumnNameLength, long length, int mysqlType, short colFlag,
        ...
        if (this.sqlType == Types.TINYINT && this.length == 1 /* && this.conn.tinyint1isBit */) {
